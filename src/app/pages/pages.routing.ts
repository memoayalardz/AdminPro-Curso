...
const routes: Routes = [
    { 
        ...
        children: [
            ...
            { path: 'medico/:id', component: MedicoComponent , data:{titulo:'Administración de Médicos'}},
            // Admin
            { path: 'usuarios',canActivate: [AdminGuard], component: UsuariosComponent , data:{titulo:'Administración de Usuarios'}},
            // Buscar
